...
import { bookings, bookingItems, roomSeats, seatTypes, showtimeSeats, cinemas, rooms, roomTypes, seatLayouts, seatLayoutItems, tickets, showtimes, transactions, users, transactionLogs, bookingLogs, genres, movieGenreMapping, movies, movieFormats, permissions, rolePermissions, roles, userRoles, telescopeEntries, telescopeEntriesTags } from "./schema";
